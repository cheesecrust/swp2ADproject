...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.message = ""
        self.stateMessage = QLabel('', self)
        self.stateMessage.setFont(QtGui.QFont("궁서", 30))
        ...
        self.resultMessage.setFixedWidth(350)
        self.resultMessage.setFont(QtGui.QFont("궁서", 20))
        self.resultMessage.move(650, 550)

        self.reGameButton = QPushButton("reStart", self)
        self.reGameButton.setFont(QtGui.QFont("궁서", 10))
        self.reGameButton.resize(50, 50)
        self.reGameButton.move(850, 550)
        self.reGameButton.clicked.connect(self.clickedReGame)
    ...
    def reMake(self):
        ...
        self.turnMessage = '{0} player WIN'.format(self.turn)
        ...
        try:
            ...
            self.i_StealButton.setText(makeMap.deck2p[2])
            self.j_StealButton.setText(makeMap.deck2p[3])
            self.k_StealButton.setText(makeMap.deck2p[4])
            self.l_StealButton.setText(makeMap.deck2p[5])
        except:
            print(makeMap.deck1p)
    ...
    def clickedReGame(self):
        makeMap.gameMap = [['相1', ' ', ' ', '將2'], ['王1', '子1', '子2', '王2'], ['將1', ' ', ' ', '相2']]
        makeMap.deck1p = []
        makeMap.deck2p = []
        self.turn = 1
        self.reMake()
